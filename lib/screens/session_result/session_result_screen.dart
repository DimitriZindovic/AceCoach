...
/// The generated plan with Regenerate and Save actions.
///
/// Three explicit states: generating (skeleton or overlay over the previous
/// plan), failure (with retry), and the plan itself.
